...
DATASETS = [
    ...
    Dataset(
        ...
        short_label="Drug harm",
        unit="risk index",
        metric_label="Substance-use harm index",
        ...
        source_url="https://www.healthnz.govt.nz/about-us/health-data/health-surveys/new-zealand-health-survey",
        low_label="Lower pressure",
        high_label="Higher pressure",
    ...
    Dataset(
        ...
        metric_label="Recorded victimisations per 1,000 people",
        ...
        low_label="Lower rate",
        high_label="Higher rate",
        pipeline="police_crime_rate",
    ),
    Dataset(
        id="demographics",
        label="Demographic change",
        short_label="Demographics",
        unit="change index",
        metric_label="Age and ethnic diversity change index",
        ...
        source_url="https://www.stats.govt.nz/topics/population/",
        low_label="Slower change",
        high_label="Faster change",
...
SOURCES = [
    ...
    {
        "id": "nz_health_survey",
        "name": "New Zealand Health Survey",
        "owner": "Health New Zealand / Ministry of Health",
        "url": "https://www.healthnz.govt.nz/about-us/health-data/health-surveys/new-zealand-health-survey",
        "notes": "Population health survey including substance-use and mental-health indicators.",
    },
    {
        "id": "drug_harm_index",
        "name": "New Zealand Drug Harm Index",
        "owner": "Ministry of Health",
        "url": "https://www.health.govt.nz/system/files/2016-04/nz-drug-harm-index-2016-2nd-ed-jul16.pdf",
        "notes": "Framework for weighting substance-use harm across drug classes.",
    },
    {
        "id": "police_data",
        "name": "policedata.nz",
        ...
        "notes": "Recorded crime victimisations, offenders, and demand/activity tables.",
    },
]
...
DATASET_SOURCES = {
    ...
    "drugUse": ["nz_health_survey", "drug_harm_index"],
    "crimeRate": ["police_data", "stats_nz"],
    "demographics": ["stats_nz"],
}
...
SEED_SERIES = {
    ...
    "drugUse": {
        "northland": [36, 38, 42, 47, 54, 58],
        "auckland": [30, 32, 36, 41, 48, 52],
        "waikato": [32, 35, 40, 46, 55, 61],
        "bay-of-plenty": [34, 36, 42, 49, 58, 64],
        "gisborne": [38, 41, 48, 56, 66, 72],
        "hawkes-bay": [35, 38, 44, 51, 61, 67],
        "taranaki": [30, 33, 38, 44, 52, 57],
        "manawatu-whanganui": [34, 37, 43, 51, 60, 66],
        "wellington": [26, 28, 32, 36, 41, 45],
        "west-coast": [37, 40, 45, 53, 62, 68],
        "tasman": [25, 27, 31, 35, 40, 44],
        "nelson": [28, 30, 34, 39, 45, 49],
        "marlborough": [27, 29, 33, 38, 44, 49],
        "canterbury": [29, 31, 35, 40, 46, 51],
        "otago": [28, 30, 34, 39, 45, 50],
        "southland": [33, 36, 42, 49, 58, 64],
    },
    "crimeRate": {
        "northland": [73, 76, 82, 88, 94, 98],
        "auckland": [62, 66, 72, 80, 86, 91],
        "waikato": [68, 72, 78, 86, 95, 101],
        "bay-of-plenty": [72, 75, 82, 90, 99, 106],
        "gisborne": [78, 82, 90, 99, 110, 118],
        "hawkes-bay": [70, 74, 82, 91, 102, 109],
        "taranaki": [54, 57, 63, 69, 75, 79],
        "manawatu-whanganui": [66, 70, 78, 87, 96, 104],
        "wellington": [50, 52, 57, 63, 69, 73],
        "west-coast": [55, 58, 64, 72, 79, 84],
        "tasman": [38, 40, 44, 48, 52, 55],
        "nelson": [52, 55, 61, 67, 74, 79],
        "marlborough": [47, 50, 55, 61, 67, 72],
        "canterbury": [56, 58, 63, 69, 76, 81],
        "otago": [44, 46, 50, 55, 61, 65],
        "southland": [49, 52, 58, 65, 72, 78],
    },
    "demographics": {
        "northland": [28, 31, 35, 41, 48, 55],
        "auckland": [55, 60, 67, 75, 84, 90],
        "waikato": [35, 39, 45, 53, 62, 70],
        "bay-of-plenty": [33, 37, 43, 51, 61, 69],
        "gisborne": [30, 34, 40, 48, 57, 65],
        "hawkes-bay": [31, 34, 39, 46, 54, 61],
        "taranaki": [24, 27, 31, 36, 42, 48],
        "manawatu-whanganui": [29, 32, 37, 44, 51, 58],
        "wellington": [43, 47, 53, 60, 68, 75],
        "west-coast": [16, 18, 21, 25, 30, 35],
        "tasman": [22, 25, 29, 35, 42, 49],
        "nelson": [30, 33, 38, 45, 52, 59],
        "marlborough": [23, 26, 31, 37, 44, 51],
        "canterbury": [34, 38, 44, 52, 61, 69],
        "otago": [28, 31, 37, 45, 54, 62],
        "southland": [18, 20, 24, 29, 35, 41],
    },
}
...
PIPELINE_NOTES = {
    ...
    "health_drug_harm": "Seeded now. Target: combine NZ Health Survey substance-use estimates, Health NZ releases, and Drug Harm Index weightings by region.",
    "police_crime_rate": "Seeded now. Target: join Police recorded victimisations with Stats NZ regional population estimates to calculate rates per 1,000 people.",
    "stats_nz_demographics": "Seeded now. Target: Stats NZ census and population tables for age, ethnicity, migration, and diversity indicators.",
}
